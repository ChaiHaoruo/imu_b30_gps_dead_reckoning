...
public:
    ...
    void B30DepthCallback(const sensor_msgs::FluidPressureConstPtr& B30_msg_ptr);

private:
    void LogState(const ImuGpsLocalization::State& state);
    void LogGps(const ImuGpsLocalization::GpsPositionDataPtr gps_data);
    void LogB30(const ImuGpsLocalization::B30DepthDataPtr B30_data);
    ...
    ros::Subscriber B30_sub;

    std::ofstream file_state_;
    std::ofstream file_gps_;
    std::ofstream file_B30_;
